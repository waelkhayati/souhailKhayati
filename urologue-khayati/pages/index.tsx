  ...
  return (
    <>
      <Head>
          ...
          <meta
            name="description"
            content="Herzlich willkommen in der Wahlarztordination Dr. Souhail Khayati. Kontaktieren Sie uns noch heute, um einen Termin zu vereinbaren."
          />
          <meta
            name="keywords"
            content="Khayati, Urologe Khayati, Urologie, Radiooncologie, Urooncologie, Urologie Hausmannstätten, Urologe Hausmannstätten, Andrologie, Souhail Khayati, Souhail Khayati, Graz, Urologe Graz, Urologe Graz-Umgebung, Hausmannstätten, Österreichische Gesellschaft für Urologie und Andrologie, Eruopean Assosication of Urology, Arbeitskreis für Andrologie und sexuelle Funktionsstörungen, Österreichische Gesellschaft für Radioonkologie, Urologie Praxis Graz, Facharzt für Urologie, Urologische Untersuchungen, Prostatakrebs Behandlung, Männergesundheit, Harnwegsinfektionen, Urologische Chirurgie, Blasenprobleme, Hodenerkrankungen, Nierennentfernung, Urologische Diagnostik, Andrologische Beratung, Prostatauntersuchung, Urologische Vorsorge, Urologische Rehabilitation, Urologische Therapieoptionen, Inkontinenzbehandlung, Urologische Praxis Hausmannstätten, Dr. Souhail Khayati, Urologe Graz-Umgebung, Urologische Gesundheitsberatung, Urologische Untersuchungsmethoden, Urologische Krankheiten, Urologische Operationen, Universitätsklinikum Graz, Med-Uni Graz, Medizinische Universität Graz, Abteilung für Urologie Med-Uni. Graz, Radioonkologie und Strahlentherapie medizinische, Universität Graz, LKH GRAZ, KAGES UROLOGIE, Urologe Graz, Graz-Umgebung, Rezüm Khayati, Steiermark, Klasdorf, Fernitz, Berndorf, Grambach, Raaba"
          />
          ...
          <script
            src="https://www.google.com/recaptcha/api.js?onload=getcaptcharesponse&render=explicit"
            async
            defer
          ></script>
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              description:
                "Herzlich willkommen in der Wahlarztordination Dr. Souhail Khayati. Kontaktieren Sie uns noch heute, um einen Termin zu vereinbaren.",
